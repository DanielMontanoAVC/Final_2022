...
$H_0$ There is no effectiveness in the new Covid921 vaccine when dealing with all sub-groups.
$H_A$ There is effectiveness in the new Covid921 vaccine when dealing with all sub-groups.
